                ...
                for (j = 1; j <= i__1; ++j) {
                    ...
                    if (x[i__2].r != 0.f || x[i__2].i != 0.f) {
                        ...
                        for (i__ = max(i__2, i__3); i__ <= i__4; ++i__) {
                            ...
                            i__3 = i__;
                            i__5 = l + i__ + j * a_dim1;
                            q__2.r = temp.r * a[i__5].r - temp.i * a[i__5].i, q__2.i = temp.r * a[i__5].i +
                                                                                       temp.i * a[i__5].r;
                ...
                for (j = *n; j >= 1; --j) {
                    ...
                    if (x[i__1].r != 0.f || x[i__1].i != 0.f) {
                        ...
                        for (i__ = min(i__1, i__3); i__ >= i__4; --i__) {
                            ...
                            i__3 = i__;
                            i__2 = l + i__ + j * a_dim1;
                            q__2.r = temp.r * a[i__2].r - temp.i * a[i__2].i, q__2.i = temp.r * a[i__2].i +
                                                                                       temp.i * a[i__2].r;
                            q__1.r = x[i__3].r + q__2.r, q__1.i = x[i__3].i + q__2.i;
            ...
            if (*incx == 1) {
                for (j = *n; j >= 1; --j) {
                    ...
                    if (noconj) {
                        if (nounit) {
                            i__3 = kplus1 + j * a_dim1;
                            q__1.r = temp.r * a[i__3].r - temp.i * a[i__3].i, q__1.i = temp.r * a[i__3].i +
                                                                                       temp.i * a[i__3].r;
                        ...
                        for (i__ = j - 1; i__ >= i__3; --i__) {
                            ...
                            i__4 = i__;
                            q__2.r = q__3.r * x[i__4].r - q__3.i * x[i__4].i, q__2.i = q__3.r * x[i__4].i +
                                                                                       q__3.i * x[i__4].r;
                            q__1.r = temp.r + q__2.r, q__1.i = temp.i + q__2.i;
                            temp.r = q__1.r, temp.i = q__1.i;
                            /* L100: */
            ...
            if (*incx == 1) {
                ...
                for (j = 1; j <= i__3; ++j) {
                    ...
                    if (noconj) {
                        if (nounit) {
                            i__4 = j * a_dim1 + 1;
                            q__1.r = temp.r * a[i__4].r - temp.i * a[i__4].i, q__1.i = temp.r * a[i__4].i +
                                                                                       temp.i * a[i__4].r;
                            temp.r = q__1.r, temp.i = q__1.i;
                        }
                        /* Computing MIN */
                        ...
                        for (i__ = j + 1; i__ <= i__4; ++i__) {
                            r_cnjg(&q__3, &a[l + i__ + j * a_dim1]);
                            i__1 = i__;
                            q__2.r = q__3.r * x[i__1].r - q__3.i * x[i__1].i, q__2.i = q__3.r * x[i__1].i +
                                                                                       q__3.i * x[i__1].r;
                            q__1.r = temp.r + q__2.r, q__1.i = temp.i + q__2.i;
                            temp.r = q__1.r, temp.i = q__1.i;
                            /* L160: */
