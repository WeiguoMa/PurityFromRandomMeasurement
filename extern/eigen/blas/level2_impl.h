...
(const char *uplo, const char *opa, const char *diag, const int *n, const RealScalar *pa, const int *lda,
 RealScalar *pb, const int *incb) {
    ...
    static const functype func[16] = {
            ...
            (Eigen::internal::triangular_solve_vector<Scalar, Scalar, int, OnTheLeft, Lower | 0, Conj, RowMajor>::run),
            0,
            ...
            (Eigen::internal::triangular_solve_vector<Scalar, Scalar, int, OnTheLeft, Upper | 0, Conj, RowMajor>::run),
            0,
            ...
            (Eigen::internal::triangular_solve_vector<Scalar, Scalar, int, OnTheLeft,
...
(const char *uplo, const char *opa, const char *diag, const int *n, const RealScalar *pa, const int *lda,
 RealScalar *pb, const int *incb) {
    ...
    static const functype func[16] = {
            // array index: NOTR  | (UP << 2) | (NUNIT << 3)
            (Eigen::internal::triangular_matrix_vector_product<int,
 ...
 RealScalar *pbeta, RealScalar *py, int *incy) {
    ...
    for (int j = 0; j < nb; ++j) {
        ...
        if (OP(*trans) == NOTR)
            ...
            actual_y[j] +=
                    alpha *
                    (mat_coeffs.col(j).segment(offset, len).adjoint() * make_vector(actual_x + start, len)).value();
    }
...
(char *uplo, char *op, char *diag, int *n, int *k, RealScalar *pa, int *lda, RealScalar *px, int *incx) {
    ...
    static const functype func[16] = {
            ...
            0,
            // array index: NOTR  | (UP << 2) | (UNIT  << 3)
            (Eigen::internal::band_solve_triangular_selector<int,
                    Upper | UnitDiag, Scalar, false, Scalar, ColMajor>::run),
            // array index: TR    | (UP << 2) | (UNIT  << 3)
            (Eigen::internal::band_solve_triangular_selector<int,
                    Lower | UnitDiag, Scalar, false, Scalar, RowMajor>::run),
            // array index: ADJ   | (UP << 2) | (UNIT  << 3)
            (Eigen::internal::band_solve_triangular_selector<int,
                    Lower | UnitDiag, Scalar, Conj, Scalar, RowMajor>::run),
            0,
            // array index: NOTR  | (LO << 2) | (UNIT  << 3)
            (Eigen::internal::band_solve_triangular_selector<int,
                    Lower | UnitDiag, Scalar, false, Scalar, ColMajor>::run),
            // array index: TR    | (LO << 2) | (UNIT  << 3)
            (Eigen::internal::band_solve_triangular_selector<int,
                    Upper | UnitDiag, Scalar, false, Scalar, RowMajor>::run),
            // array index: ADJ   | (LO << 2) | (UNIT  << 3)
            (Eigen::internal::band_solve_triangular_selector<int,
                    Upper | UnitDiag, Scalar, Conj, Scalar, RowMajor>::run),
            0,
    };
...
EIGEN_BLAS_FUNC(tpmv)(char *uplo, char *opa, char *diag, int *n, RealScalar *pap, RealScalar *px, int *incx) {
    ...
    static const functype func[16] = {
            ...
            0,
            // array index: NOTR  | (UP << 2) | (UNIT  << 3)
            (Eigen::internal::packed_triangular_matrix_vector_product<int,
                    Upper | UnitDiag, Scalar, false, Scalar, false,
                    ColMajor>::run),
            // array index: TR    | (UP << 2) | (UNIT  << 3)
            (Eigen::internal::packed_triangular_matrix_vector_product<int,
                    Lower | UnitDiag, Scalar, false, Scalar, false,
                    RowMajor>::run),
            // array index: ADJ   | (UP << 2) | (UNIT  << 3)
            (Eigen::internal::packed_triangular_matrix_vector_product<int,
                    Lower | UnitDiag, Scalar, Conj, Scalar, false,
                    RowMajor>::run),
            0,
            // array index: NOTR  | (LO << 2) | (UNIT  << 3)
            (Eigen::internal::packed_triangular_matrix_vector_product<int,
            ...
            // array index: ADJ   | (LO << 2) | (UNIT  << 3)
            (Eigen::internal::packed_triangular_matrix_vector_product<int,
                    Upper | UnitDiag, Scalar, Conj, Scalar, false,
                    RowMajor>::run),
            0};
