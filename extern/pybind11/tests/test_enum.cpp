...
TEST_SUBMODULE(enums, m) {
    ...
    enum class ScopedWCharEnum : wchar_t {
        Zero, Positive
    };
    enum class ScopedChar32Enum : char32_t {
        Zero, Positive
    };
    enum class ScopedChar16Enum : char16_t {
        Zero, Positive
    };
    ...
    enum class ScopedChar8Enum : char8_t {
        Zero, Positive
    };
