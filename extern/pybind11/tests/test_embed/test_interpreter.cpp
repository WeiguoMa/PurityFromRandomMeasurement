...
auto sys_path = py::str(py::module_::
import("sys").attr("path")).
...
REQUIRE_NOTHROW(py::module_::
import("widget_module"));
REQUIRE_THROWS_WITH(py::module_::
import("throw_exception"), "ImportError: C++ Error");
REQUIRE_THROWS_WITH(py::module_::
...
REQUIRE(py::module_::
import("widget_module").attr("add")(1, 41).
...
== path_size_add_program_dir_to_path_false + 1);
}
...
REQUIRE(py::module_::
import("widget_module").attr("add")(1, 2).
...
REQUIRE(py::module_::
import("external_module").attr("A")(123).attr("value").
...
== py::module_::import("external_module").attr("internals_at")().
...
REQUIRE_FALSE (py::hasattr(py::module_::
